...
function roundToPowerOfTen(num, pow) {
    let numStr = num.toPrecision();
    const withComma = `${numStr.slice(0, numStr.length - pow)}.${numStr.slice(numStr.length - pow)}`;
    const number = Math.round(Number.parseFloat(withComma));
